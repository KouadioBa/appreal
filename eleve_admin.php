<?php
    ...
    if($_POST){
        ...
        if(!empty($firstname) && !empty($name) && !empty($age) && !empty($image)){
            $db->exec('INSERT INTO eleves (firstname,name,age,image) VALUES ("'.$firstname.'","'.$name.'","'.$age.'","'.$image.'")');
        }
        else{
            ...
            <li class="nav-item">
                ...
                <div id="collapseCompo" class="collapse" aria-labelledby="headingCompo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"><h6 class="collapse-header">Compos:</h6>
                        <a class="collapse-item" href="composition_one.html">compositon 1</a>
                        <a class="collapse-item" href="composition_two.html">compositon 2</a>
                        <a class="collapse-item" href="composition_three.html">compositon 3</a>
                        <a class="collapse-item" href="composition_for.html">compositon 4</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Systèmes d'Administration des élèves <button type="button" class="btn btn-success"><a href="add.php" style="text-decoration:none;color: white">Ajouter</a></button></h1>
                    </div>

                    <div class="container" style="background: #4e73df;height: auto;width: 100%;padding: 20px;border-radius: 10px;">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($row = $result->fetchArray(SQLITE3_ASSOC)){
                                        echo "
                                        <tr>
                                            <td scope='row' style='color: white;'>".$row['id']."</td>
                                            <td style='color: white;'>".$row['firstname']."</td>
                                            <td style='color: white;'>".$row['name']."</td>
                                            <td style='color: white;'>".$row['age']."</td>
                                            <td style='width:30%'>
                                                <button class='btn btn-info'><a href='update.php?id=".$row['id']."' style='text-decoration:none;color:white;'>Modifier</a></button>
                                                <button class='btn btn-light'><a href='savoir_plus.php?id=".$row['id']."' style='text-decoration:none;color:#4e73df'>Voir</a></button>
                                                <button class='btn btn-danger'><a a href='delete.php?id=".$row['id']."' style='text-decoration:none;color:white'>Supprimer</a></button>
                                            </td>
                                      </tr>
                                        ";
                                    }
                        ...
                        <button class="btn btn-info"><a href="eleve.php" style="text-decoration:none;color: white">Liste des Élèves</a></button>
                    </div>
